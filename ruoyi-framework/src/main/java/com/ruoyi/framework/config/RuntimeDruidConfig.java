...
import com.ruoyi.framework.datasource.runtime.RuntimeDynamicDataSource;
...
/**
 * @description: 实现项目运行时动态切换数据源
 * @author: zhangxiulin
 * @time: 2020/12/12 13:55
 */
@Configuration
public class RuntimeDruidConfig {
    ...
    public void setCustomizedDataSources(Map<Object, Object> targetDataSources){

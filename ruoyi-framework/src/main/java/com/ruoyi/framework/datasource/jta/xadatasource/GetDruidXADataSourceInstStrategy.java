 ...
 */
@Component
public class GetDruidXADataSourceInstStrategy implements IGetXADataSourceInstStrategy {

    private static final Logger log = LoggerFactory.getLogger(GetDruidXADataSourceInstStrategy.class);
    ...
    @Override
    public XADataSource getInstance(Properties properties) {

 ...
 */
@Component
public class InDtx2pcAggregateStrategy implements IInAggregateStrategy {

    private static final Logger log = LoggerFactory.getLogger(InDtx2pcAggregateStrategy.class);
    ...
    public Object aggregate(InAggregateRequestVo request) {
        log.info("聚合服务[" + request.getReqId() + "]的分布式事务策略[2PC]");

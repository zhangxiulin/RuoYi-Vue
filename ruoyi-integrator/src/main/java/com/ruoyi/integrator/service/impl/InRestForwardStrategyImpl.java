 ...
 */
@Component
public class InRestForwardStrategyImpl implements IInForwardStrategy {

    private static final Logger logger = LoggerFactory.getLogger(InRestForwardStrategyImpl.class);

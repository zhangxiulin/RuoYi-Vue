 ...
 */
@Component
public class InSqlQueryAggregateForwardStrategy implements IInAggregateForwardStrategy {

    private static final Logger log = LoggerFactory.getLogger(InSqlQueryAggregateForwardStrategy.class);

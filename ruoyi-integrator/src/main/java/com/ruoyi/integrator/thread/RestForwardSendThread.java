                    ...
                    case HTTP:
                    {
                        ...
                        if (StringUtils.isNotEmpty(inForwardInfo.getForwardMethod())){
                            ...
                            if (InForwardMethod.GET == forwardMethodEnum){
                                ...
                                try {
                                    String rtString = HttpUtils.sendGet(inForwardInfo.getForwardUrl(), sendData);
                                ...
                                try {
                                    String rtString = HttpUtils.sendJsonPost(inForwardInfo.getForwardUrl(), sendData);
                                    result = AjaxResult.success("转发编号["+inForwardInfo.getForwardCode()+"]转发成功", rtString);
                                } catch (Exception e) {
                                    String errMsg = "转发编号[" + inForwardInfo.getForwardCode() + "]异常";
                                    logger.error(errMsg, e);
                                ...
                                try {
                                    String rtString = HttpUtils.sendJsonPut(inForwardInfo.getForwardUrl(), sendData);
                                    result = AjaxResult.success("转发编号["+inForwardInfo.getForwardCode()+"]转发成功", rtString);
                                } catch (Exception e) {
                                    String errMsg = "转发编号[" + inForwardInfo.getForwardCode() + "]异常";
                                    logger.error(errMsg, e);
                                ...
                                try {
                                    String rtString = HttpUtils.sendJsonDelete(inForwardInfo.getForwardUrl(), sendData);
                                    result = AjaxResult.success("转发编号["+inForwardInfo.getForwardCode()+"]转发成功", rtString);
                                } catch (Exception e) {
                                    String errMsg = "转发编号[" + inForwardInfo.getForwardCode() + "]异常";
                                    logger.error(errMsg, e);

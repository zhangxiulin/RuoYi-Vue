 ...
 */
public class Dtx2pcAggregateThread implements Callable<AjaxResult> {

    private static final Logger logger = LoggerFactory.getLogger(Dtx2pcAggregateThread.class);
    ...
    public Dtx2pcAggregateThread(InAggregation inAggregation, List sendVarList, List sendDataList){
